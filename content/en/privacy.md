---
title: "Website statistics and privacy"
description: "The coverage and mode of exit of Wiki."
lang: en
---

The site uses hosting Umami to learn about page views, the source website, the type of equipment, and to read the middle, end and next page. Data are kept on servers managed by the operator at this station and the statistical backstage is closed to the public.

No screen recording enabled, no search words in the station, no active association of names, mailboxes or account identities. The number of visits and visitors is an estimate; rolling to the end of the text does not mean that they have been carefully read.
